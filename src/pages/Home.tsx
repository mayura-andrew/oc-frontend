  ...
  return (
    <>
      <div className="flex flex-col min-h-screen">
        {/* Hero Section */}
        <section id="hero-section" className="bg-gradient-to-r from-slate-50 to-slate-100 py-20">
            ...
            <div className="flex items-center justify-center gap-6 md:gap-10 font-inter">
              <div className="max-w-2xl space-y-7 md:ml-6 lg:ml-10">
                ...
                <p className="text-lg md:text-lg text-blue-900 text-justify">
                  Join the OpenConnect community and discover meaningful connections with
                  professionals and mentors in your field.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button className="text-base py-6 px-8" onClick={() => navigate('/community')}>
              ...
              <div className="relative hidden md:flex items-center justify-center">
                <div className="w-5/6 h-5/6 flex items-center justify-center">
                  <img src={ForHomeImage} alt="OpenConnect" className="max-w-full h-auto" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-b from-slate-50 to-slate-100 py-16">
          <div className="container mx-auto px-4 md:px-6 text-center py-10">
            ...
            <p className="text-xl text-gray-500 mb-8 max-w-3xl mx-auto">
              Join thousands of professionals who are already connecting, collaborating, and growing
              together.
            </p>
            <Button
